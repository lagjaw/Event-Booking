  ...
  return (
    <>
      <div
        key={cart.id}
        onClick={togglePopup}
        className="w-full flex items-center p-2 py-6 hover:bg-gray-100 hover:rounded-md hover:border hover:border-gray-100 hover:cursor-pointer"
      >
        {event ? (
          <>
            ...
            <div className="ml-4 flex flex-1 flex-col">
              <div>
                ...
                <div className="flex justify-between text-base font-medium text-gray-900">
                  <p className="mt-1 text-sm text-gray-500">{ville?.ville}</p>
